      ...
      <section className='p-6 bg-white'>
        ...
        <div className='flex flex-wrap gap-4 md:gap-3 justify-center'>
          <div className='bg-white border-4 border-gray-400 w-32 h-32 md:w-25 md:h-25 flex flex-col justify-center items-center '>
            ...
            <i className='fa-solid fa-mobile-screen-button text-3xl mb-2' />
          ...
          <div className='bg-red-600 text-white w-32 h-32 md:w-25 md:h-25 flex flex-col justify-center items-center'>
            <img src='/iconos2/camara.png' alt='Camara' />
            <i className='fa-solid fa-camera text-3xl mb-2 text-white' />
            <p>Camera</p>
          </div>
